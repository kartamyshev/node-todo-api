...
app.delete('/todo/:id', authenticate, async (request, response, next) => {
  const { id } = request.params;
...
app.post('/user/add', async (request, response, next) => {
  try {
...
app.delete('/users/me/token', authenticate, async (request, response, next) => {
  try {
